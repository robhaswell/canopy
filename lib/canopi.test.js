...
test('logging messages and objects', (t) => {
  ...
  t.equals(b.value.replace(/("stack":")CanopiUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"info","err":{"name":"CanopiUsageError","message":"When logging a string message, the second argument must be an obejct if provided","stack":"STACK"}}\n')
  b.reset()
})
