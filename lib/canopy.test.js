...
test('logging messages and objects', (t) => {
  ...
  t.equals(b.value.replace(/("stack":")CanopyUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"info","err":{"name":"CanopyUsageError","message":"When logging a string message, the second argument must be an obejct if provided","stack":"STACK"}}\n')
  b.reset()
})
...
test('logging objects', (t) => {
  ...
  t.equals(b.value.replace(/("stack":")CanopyUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"info","err":{"name":"CanopyUsageError","message":"When logging an object, there can be no other arguments","stack":"STACK"}}\n')
  b.reset()
})
...
test('logging errors', (t) => {
  ...
  log.error(err, 1)
  t.equals(b.value.replace(/("stack":")CanopyUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"error","err":{"name":"CanopyUsageError","message":"When logging an error, the second argument must be a string or object if provided","stack":"STACK"}}\n')
  b.reset()
})
...
test('error handlers', (t) => {
  ...
  canopy.addErrorHandler(handler)
...
test('unsupported uses', (t) => {
  ...
  log.info()
  t.equals(b.value.replace(/("stack":")CanopyUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"info","err":{"name":"CanopyUsageError","message":"Log message, object or error not provided","stack":"STACK"}}\n')
  b.reset()

  log.info(1)
  t.equals(b.value.replace(/("stack":")CanopyUsageError:[^"]+/, '$1STACK'),
    '{"timestamp":"2001-02-01T01:01:01.001Z","severity":"info","err":{"name":"CanopyUsageError","message":"Unsupported argument","stack":"STACK"}}\n')
  b.reset()
})
