    ...
    canopiLogger[level] = function (a1, a2) {
      ...
      try {
        if (typeof (a1) === 'string') {
          ...
          // Messages and objects are logedg before the error for readability.
          if (typeof (a2) === 'string') {
            loggable.message = a2
...
const addFormatter = (key, formatter) => {
...
module.exports.addFormatter = addFormatter
module.exports.defaultFormatters = () => {
  addFormatter('req', requestFormatter)
}
